...
import { Modal, TouchableOpacity, Text, TouchableHighlight, View, TextInput } from 'react-native';
...
function CatModal({ modalVisible, closeModal }) {
    ...
    return (
        <Modal
            ...
            <FulscreenModal closeModal={closeModal} title={'Categories'} />
            ...
            <Modal
                ...
                <SmallModal2 title={'Add Category'} closeModal={closeCatModal} data={[]}
                    Contains={
                        <>
